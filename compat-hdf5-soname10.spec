...
Source0  : https://support.hdfgroup.org/ftp/HDF5/current18/src/hdf5-1.8.21.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1566502332
...
/usr/lib64/libhdf5.so.10.3.2
/usr/lib64/libhdf5_hl.so.10
/usr/lib64/libhdf5_hl.so.10.2.2
